...
The earlier run at `/home/zerlinshen/projects/reference-atlas-ood-validation/runs/2026-08-22T1534Z-3749a2d/` is retained as superseded diagnostic evidence: it incorrectly treated bounded distance-only float drift as scientific nondeterminism. The clean replacement `/home/zerlinshen/projects/reference-atlas-ood-validation/runs/2026-08-22T1558Z-c38053d/` passed OOD, repeatability, CUDA-residency, and CPU/GPU parity gates. Exact scientific outputs shared SHA-256 `a24437b8da0c99b0af2179c9caf49ada80de01f29c744864a93b6ce4d5202a83`; maximum GPU within-lane distance drift was `4.77e-7`, CPU/GPU distance difference was `9.2e-7`, and the isolated median speedup was `11.04x`.
